...
import (
	...
	"github.com/daheige/gorpc/internal/pkg/helper"
)
...
func AccessLog(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo,
	...
	// request ctx key
	if logID := ctx.Value(ckeys.XRequestID.String()); logID == nil {
		ctx = context.WithValue(ctx, logger.XRequestID, gmicro.RndUUIDMd5())
	}
...
func GatewayAccessLog(mux *gRuntime.ServeMux) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		r = helper.SetValueToHTTPCtx(r, logger.ReqClientIP, httpRealIP(r))
		r = helper.SetValueToHTTPCtx(r, logger.RequestMethod, r.Method)
		r = helper.SetValueToHTTPCtx(r, logger.RequestURI, r.RequestURI)
